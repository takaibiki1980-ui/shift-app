            ...
            return (
              <tr key={s.id} style={{background:si%2===0?"#ffffff":"#fafeff"}}>
                ...
                {rightCols.map(col=>{
                  ...
                  else{const mx=dept.shiftMaxByType?.[col]||0;const over=mx>0&&cnt>mx;val=cnt||"－";color=over?"#ef4444":(SHIFTS[col]?.color||"#2a7a77");}
