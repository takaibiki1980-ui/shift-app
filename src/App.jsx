...
function Legend() {
  ...
  return (
    <div style={{padding:"4px 0",borderBottom:"1px solid #E4E4E7",marginBottom:6,display:"flex",flexWrap:"wrap",gap:6,alignItems:"center"}}>
      ...
      <span style={{display:"inline-flex",alignItems:"center",gap:2,marginLeft:6}}><span style={{width:11,height:11,border:"2px dashed #dc2626",borderRadius:2,display:"inline-block"}}/><span style={{fontSize:9,color:"#6B7280"}}>スタッフ希望(休/有)</span></span>
