...
function Legend() {
  ...
  return (
    <div style={{padding:"4px 0",borderBottom:"1px solid #E4E4E7",marginBottom:6,display:"flex",flexWrap:"wrap",gap:6,alignItems:"center"}}>
      ...
      <span style={{display:"inline-flex",alignItems:"center",gap:2,marginLeft:6}}><span style={{width:11,height:11,border:"2px dashed #f87171",borderRadius:2,display:"inline-block"}}/><span style={{fontSize:9,color:"#6B7280"}}>スタッフ希望(休/有)</span></span>
      <span style={{display:"inline-flex",alignItems:"center",gap:2}}><span style={{width:11,height:11,border:"2px dashed #a78bfa",borderRadius:2,display:"inline-block"}}/><span style={{fontSize:9,color:"#6B7280"}}>リーダー希望</span></span>
          ...
          <div style={{position:"relative"}}>
            ...
            {overflowOpen&&<>
              ...
              <div style={{position:"absolute",right:0,top:"calc(100% + 6px)",background:"#FFFFFF",border:"1px solid #E5E7EB",borderRadius:10,boxShadow:"0 8px 24px rgba(0,0,0,0.10)",zIndex:100,minWidth:180,overflow:"hidden",padding:"4px 0"}}>
                ...
                {EDIT_MODE_ENABLED && !isLocked && editEra && <div onClick={()=>{clearEditsOnly();setOverflowOpen(false);}} title="生成後の修正だけをまとめて取り消します（生成前の希望は残ります）" style={{display:"flex",alignItems:"center",gap:10,padding:"10px 16px",cursor:"pointer",fontSize:12,color:"#047857",borderTop:"1px solid #F1F5F9"}} onMouseEnter={e=>e.currentTarget.style.background="#ECFDF5"} onMouseLeave={e=>e.currentTarget.style.background="transparent"}><Trash2 size={14} strokeWidth={2} style={{color:"#047857"}}/><span>修正だけ削除</span></div>}
