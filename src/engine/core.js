...
// 第1段階: 30→150。第2段階: 150→250（実測でmaxStaff超過0/役職0/公休乖離ほぼ0を確認）。
// ※250>maxStaff単価150 だが、早番/遅番/夜勤はTier1役割席でrepairがmaxStaffを別途強制するため
//   スコア重みが150を超えてもmaxStaff超過は構造的に0のまま。上げすぎの上限は公平性2000側。
const LEARN_WEIGHT = 250;
